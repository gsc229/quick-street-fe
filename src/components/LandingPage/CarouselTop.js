    ...
    return (
      ...
      >
        <div style={{ margin: 10 }}>
          ...
          <p className='content'>
            Cookie Bites - Dietary friendly cookies with all locally sourced
            ingredients.
          </p>
        </div>
        <div style={{ margin: 10 }}>
          ...
          <p className='content'>
            Brad's Bread- Seasonal breads from the region.
          </p>
        </div>
        <div style={{ margin: 10 }}>
          <img src={ramen} alt='img' />
          <p className='content'>
            One Meal - An easy way to have at least one meal.
          </p>
        </div>
        <div style={{ margin: 10 }}>
          <img src={egg} alt='img' />
