			...
			<form className={editingProduct.edit_product_form}>
				...
				<div className={editingProduct.input_wrapper}>
					<div className={`form-check ${editingProduct.checkbox_wrapper}`}>
						<div>
							<input
								checked={dietsOnFile && dietsOnFile.indexOf('Gluten Free') !== -1 ? true : false}
						...
						<div>
							<input
								checked={dietsOnFile && dietsOnFile.indexOf('Vegetarian') !== -1 ? true : false}
								onChange={handleSelect}
								className={`form-check-input ${editingProduct.checkbox_input}`}
								name="diet"
								type="checkbox"
						...
						<div>
							<input
								checked={dietsOnFile && dietsOnFile.indexOf('Vegan') !== -1 ? true : false}
								onChange={handleSelect}
								className={`form-check-input ${editingProduct.checkbox_input}`}
								name="diet"
								type="checkbox"
						...
						<div>
							<input
								checked={dietsOnFile && dietsOnFile.indexOf('Keto') !== -1 ? true : false}
								onChange={handleSelect}
								className={`form-check-input ${editingProduct.checkbox_input}`}
								name="diet"
								type="checkbox"
						...
						<div>
							<input
								checked={dietsOnFile && dietsOnFile.indexOf('Dairy Free') !== -1 ? true : false}
								onChange={handleSelect}
								className={`form-check-input ${editingProduct.checkbox_input}`}
								name="diet"
								type="checkbox"
