...
const Register = (props) => {
	...
	const vendorConfirmation = () => {
		if (userInfo.step === 3) {
			return <VendorConfirmation values={userInfo} previousStep={previousStep} history={props.history} />;
		}
	};

	const customerConfirmation = () => {
		if (userInfo.step === 2 && userInfo.role === 'customer') {
			return <CustomerConfirmation values={userInfo} previousStep={previousStep} history={props.history} />;
		}
	};
