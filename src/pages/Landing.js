    ...
    <div className={landing.container}>
      ...
      <div className={landing.works_container}>
        ...
        <div className={landing.card_wrapper}>
          ...
          <div className={landing.works_content}>
            <p>
              As the customer, we can seamlessly support your local food vendor
              through a one stop shop search platform.
            </p>
          </div>
        </div>
        <div className={landing.card_wrapper}>
      ...
      <div className={landing.works_container}>
        ...
        <div className={landing.card_wrapper}>
          ...
          <div className={landing.works_content}>
            <p>
              “Market Avenue helped me find new found favorite vendors. Its like
              a whole new city to me!” - Sam B.
            </p>
          </div>
        </div>
        <div className={landing.card_wrapper}>
