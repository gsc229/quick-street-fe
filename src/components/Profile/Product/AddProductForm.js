...
const AddProductForm = ({ modal, setModal, setProducts, vendorId, products, addProductformCancelHandler }) => {
	...
	return (
		<div className={modal ? 'vendor_add_product_form_container_show' : 'vendor_add_product_form_container'}>
						...
						<div className="input_wrapper">
							<div className="vendor_product_image_container">
								{productPictureInfo.public_id ? (
									...
									<img className="vendor_product_image" src={productImg} alt="product" />
								)}
								<img
