...
const VendorProfile = (props) => {
	...
	useEffect(() => {
		async function fetchVendorInfo() {
			try {
				const vendorInfo = await axios.get(`https://quickstlabs.herokuapp.com/api/v1.0/vendors/${vendorId}`);
		...
		<div className={profile.vendor_profile_container}>
			<div className={profile.vendor_header_container}>
				...
				<div id={profile.hamburger_dropdown}>
					...
					<div
						id={profile.dropdown_links}
						className={show ? profile.hamburger_dropdown_links : profile.no_drop}
					>
				...
				<div className={banner.banner_text_btns}>
					<div className={banner.vendor_header_name}>
						<input
							...
							value={editBusinessName ? info.business_name : vendorInfo.business_name}
            ...
            <img src={save} alt='save' onClick={saveProfile} /> */}
				...
				<div className={banner.vendor_banner_image_container}>
					{bannerInfo !== `no-photo.jpg` ? (
						...
						<img className={banner.vendor_banner_image} src={picture} alt="vendor header" />
					)}
